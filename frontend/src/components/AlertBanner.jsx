export default function AlertBanner({ type = 'info', message, onClose }) {
  const styles = {
    ...
    danger: 'bg-rose-50/80 border-rose-200/60 text-rose-800',
  };
  ...
  return (
    <div className={`flex items-center gap-2.5 rounded-xl border px-4 py-3 ${styles[type]}`}>
      {icons[type]}
      <span className="text-sm font-medium flex-1">{message}</span>
      {onClose && (
        <button onClick={onClose} className="ml-2 rounded-md p-0.5 opacity-50 transition hover:opacity-100">
